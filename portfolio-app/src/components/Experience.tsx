      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {experiences.map((exp, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-0 md:left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-blue-600 border-4 border-white"></div>
                  
                  {/* Date for mobile view */}
                  <div className="md:hidden flex items-center text-blue-600 mb-2 pl-8">
                  ...
                  <div className={`w-full md:w-1/2 pl-8 md:pl-0 ${
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-6">
                      ...
                      <div className="mb-4">
                        <p className="text-lg font-medium">{exp.company}, {exp.location}</p>
                        <p className="hidden md:block text-blue-600">{exp.period}</p>
                      </div>
                      
                      <ul className={`space-y-2 ${index % 2 === 0 ? '' : 'md:list-inside'}`}>
          ...
          >
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h4 className="text-xl font-bold mb-2">Universidad Pablo de Olavide, Sevilla</h4>
              <p className="text-blue-600 mb-2">Septiembre 2020 - Septiembre 2024</p>
              <p className="text-lg">Ingeniero Informático en Sistemas de Información</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
