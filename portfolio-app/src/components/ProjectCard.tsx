...
import { FiExternalLink, FiGithub, FiClock, FiChevronDown, FiChevronUp } from 'react-icons/fi';
      ...
      <div className="relative h-56 w-full">
        <div className="w-full h-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center">
          {project.image ? (
            ...
            <span className="text-2xl font-bold text-blue-600">{project.title}</span>
          )}
        </div>
      </div>
        ...
        {showDetails && (
          ...
          >
            ...
            {project.futureFeatures && project.futureFeatures.length > 0 && (
              <>
                <h4 className="font-medium mb-2">Futuras implementaciones:</h4>
